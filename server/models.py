...
# Models go here!
class TenantInfo(db.Model, SerializerMixin):
    ...
    t1cellNumber = db.Column(db.Integer, nullable=False)
    ...
    t2cellNumber = db.Column(db.Integer, nullable=True)
    ...
    t2workNumber = db.Column(db.Integer, nullable=True)
    ...
    emergencyPhone = db.Column(db.Integer, nullable=False)
...
class TenantReceipt(db.Model, SerializerMixin):
